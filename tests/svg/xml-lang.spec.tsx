...
const _jsx = 'import{svgNS as _svgNS,jsx as _jsx}from"jsx-dom-runtime";/*#__PURE__*/';
...
describe('SVG - `xml:lang` to `lang`', () => {
  ...
  it('should transform attribute correctly', async () => {
    ...
    expect(relust).toBe(_jsx +'_jsx("text",{lang:"en-US",children:"This is some English text",ns:_svgNS});');
  });
});
