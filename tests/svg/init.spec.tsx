...
describe('<svg/> support', () => {
  ...
  it('should transform SVG', async () => {
    ...
    expect(result).toBe(
      'import{svgNS as _svgNS}from"jsx-dom-runtime";import{jsx as _jsx}from"jsx-dom-runtime";/*#__PURE__*/_jsx("svg",{width:"200",height:"200",children:/*#__PURE__*/_jsx("image",{href:"image.png",height:"200",width:200,__ns:_svgNS}),__ns:_svgNS});',
    );
  });
});
