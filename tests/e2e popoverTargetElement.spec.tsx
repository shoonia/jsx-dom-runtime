...
describe('popoverTargetElement', () => {
  it('should set popoverTargetElement element with property via button', () => {
    ...
    document.body.append(
      <>
        ...
        <button
          type="button"
          id="btn"
          popoverTargetElement={div.current}
        >
          Toggle popover
        </button>
      </>
  ...
  it('should set popoverTargetElement element with property via input[type=button]', () => {
    const div = useRef<HTMLDivElement>();
