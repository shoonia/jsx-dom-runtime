describe('CamelCase attributes name to lower case', () => {
  ...
  it('should transform `tabIndex` only in HTML', async () => {
    await expect(`
      <div tabIndex="0" />;
      <App tabIndex="0"/>;
    `).toBeTransform(i + '_jsx("div",{tabindex:"0"});App({tabIndex:"0"});');
  });
  ...
  it('should transform `referrerPolicy` attribute', async () => {
    ...
    `).toBeTransform(i + '_jsx("a",{referrerpolicy:"origin"});App({referrerPolicy:"origin"});');
  });
  ...
  it('should transform `enterKeyHint` attribute', async () => {
    await expect(`
      ...
      <App enterKeyHint="go" />;
    `).toBeTransform(i + '_jsx("input",{enterkeyhint:"go"});App({enterKeyHint:"go"});');
  });
  ...
  it('should transform `maxLength/minLength` attribute', async () => {
    ...
    `).toBeTransform(i + '_jsx("textarea",{maxlength:"2",minlength:"1"});App({maxLength:"2",minLength:"1"});');
  });
  ...
  it('should transform `inputMode` attribute', async () => {
    ...
    `).toBeTransform(i + '_jsx("input",{inputmode:"numeric"});App({inputMode:"numeric"});');
  });

  it('should transform structured item* attributes', async () => {
    await expect('<div itemID="a" itemProp="b" itemScope itemRef="c" itemType="d" />;')
      .toBeTransform(i + '_jsx("div",{itemid:"a",itemprop:"b",itemscope:"",itemref:"c",itemtype:"d"});');
  });
  ...
  it('should transform `accessKey` attribute', async () => {
    await expect(`
      <button accessKey="s" />;
      <App accessKey="s" />;
    `).toBeTransform(i + '_jsx("button",{accesskey:"s"});App({accessKey:"s"});');
  });
  ...
  it('should transform `elementTiming` attribute', async () => {
    ...
    `).toBeTransform(i + '_jsx("p",{elementtiming:"data"});App({elementTiming:"data"});');
  });
  ...
  it('should transform `fetchPriority` attribute', async () => {
    ...
    `).toBeTransform(i + '_jsx("img",{fetchpriority:"low"});App({fetchPriority:"low"});');
  });
  ...
  it('should transform `dirName` attribute', async () => {
    await expect(`
      <input dirName="rtl" />;
      <App dirName="rtl" />;
    `).toBeTransform(i + '_jsx("input",{dirname:"rtl"});App({dirName:"rtl"});');
  });
  ...
  it('should transform `formTarget` attribute', async () => {
    ...
    `).toBeTransform(i + '_jsx("input",{formtarget:"_salf"});App({formTarget:"_salf"});');
  });
  ...
  it('should transform `formMethod` attribute', async () => {
    await expect(`
      ...
      <App formMethod="get" />;
    `).toBeTransform(i + '_jsx("input",{formmethod:"get"});App({formMethod:"get"});');
  });
  ...
  it('should transform `formEncType` attribute', async () => {
    ...
    `).toBeTransform(i + '_jsx("button",{formenctype:"text/plain"});App({formEncType:"text/plain"});');
  });
  ...
  it('should transform `formAction` attribute', async () => {
    await expect(`
      <button formAction="/" />;
      <App formAction="/" />;
    `).toBeTransform(i + '_jsx("button",{formaction:"/"});App({formAction:"/"});');
  });
  ...
  it('should transform `controlsList` attribute', async () => {
    ...
    `).toBeTransform(i + '_jsx("video",{controlslist:"nofullscreen"});App({controlsList:"nofullscreen"});');
  });
  ...
  it('should transform `dateTime` attribute', async () => {
    ...
    `).toBeTransform(i + '_jsx("time",{datetime:"2018-07-07",children:"July 7"});App({dateTime:"2018-07-07",children:"July 7"});');
  });
  ...
  it('should transform `colSpan` attribute', async () => {
    await expect(`
      <td colSpan={10} />;
      <App colSpan={10} />;
    `).toBeTransform(i + '_jsx("td",{colspan:10});App({colSpan:10});');
  });
  ...
  it('should transform `colSpan` attribute', async () => {
    await expect(`
      <td rowSpan={10} />;
      <App rowSpan={10} />;
    `).toBeTransform(i + '_jsx("td",{rowspan:10});App({rowSpan:10});');
  });

  it('should transform `useMap` attribute', async () => {
    await expect('<img useMap="#infographic" src="info.png" alt="infographic" />')
      .toBeTransform(i + '_jsx("img",{usemap:"#infographic",src:"info.png",alt:"infographic"});');
  });
