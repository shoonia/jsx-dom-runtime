import { Template, createRef } from 'jsx-dom-runtime';
...
export const ListItem = ({ text }) => {
  ...
  return (
    <li ref={ref} class={s.item}>
      {text}
      <button type="button" class={s.btn} onclick={remove} aria-label="remove">
        <Template>
          {`<svg width="24" height="24" fill="#8e21b1" aria-hidden="true">
